...
<html>
	...
	<body>
		...
		if (is_mptcp())
		{
                        if (get_platform() == OS_CLI)
                        {
                                echo "YES! You're all set to use MPTCP on this device! More information on: http://multipath-tcp.org";
                                return;
                        } else {
                                echo "<h1>Am I using <a href=\"http://multipath-tcp.org\" title=\"Multipath TCP\">MPTCP</a>?</h1>";
                        ...
                        if (get_platform() == OS_CLI){
                                echo "Unfortunately, your device is not ready for MPTCP yet. More information on: http://multipath-tcp.org";
                                return;
                        } else {
                                echo "<h1>Am I using <a href=\"http://multipath-tcp.org\" title=\"Multipath TCP\">MPTCP</a>?</h1>";
